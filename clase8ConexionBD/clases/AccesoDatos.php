...
class AccesoDatos
{
    ...
    public function updateDatos($tabla,$clave,$valor,$id){
        try {
            $objetoBuscado = $this->obtenerID($id,$tabla);
            if (isset($objetoBuscado)) {
                var_dump($objetoBuscado);
                /**si hay datos en la tabla, hacer el update */
    ...
    public function obtenerID($id,$tabla){
        try {
